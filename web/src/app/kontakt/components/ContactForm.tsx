  ...
  return (
    <>
      <div className="relative">
        ...
        <label
          htmlFor={id}
          className="absolute cursor-text duration-300 bg-neutral-100 rounded-md transform -translate-y-4 scale-75 top-2 z-10 origin-[0]  px-2 peer-focus:px-2  peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1"
        >
          {name}
        </label>
      </div>
